/*
 	...
 	to increase the new class functionality without making new methods 
 	and attributes.
...
/*
 * Now from the above code we can see that haven't declared any property in the
 * Birds
 * and Mammals class but they use them, because both classes inherits the
 * Animals class
 * in result they have all the accessible attributes.
 * 
 * 
 * Note: this is an example of simple inheritance and simple hierarchy
 * inheritance.
 */

// Now we will make the Main class and will Make the some instance of Mammals
// and birs.
 ...
 * Birds eats insects!
 * 
 * Note: as you can see that both the mammals have all the accessible attributes
 * and method.
