...
/* Porgram: In this section we will learn how to use and define the 
...
class HondaBike extends Bike{
	...
	// Now we will define the run method 
	// if we don't define the run method in our class there will be compile time error.
...
/*
	Output:
	running Honda Bike Safely!  

	Note: we can not instantiated the abstract clas.
	Note: we must define the abstract method in the sub class or child class.                                         
*/