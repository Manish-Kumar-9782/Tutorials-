...
void func1(); // a declaration of the function named as komal
void func2();  // a declaration of the function named as saloni
...
void func1(){
	// this func1 function will create a scope/area (in memory) for func2 function.
	int value1 = 10;
	printf("Hello  func1\n");
}

void func2(){
	// this func2 function will create a scope/area (in memory) for func1 funciton.
	int value2 = 20;
	printf("Hell func2\n");
}

/*
	Since: both func1 and func2 have their own individual scope, 
		1. value1 cannot be used in main and func2 function.
		2. value2 cannot be used in the main and func1 function.
