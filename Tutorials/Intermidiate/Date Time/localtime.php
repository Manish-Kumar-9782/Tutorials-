...
<body class="p-5">
    ...
    /**
     * In this section we will learn about the `localtime` function. 
     * 
     * localtime: Get the local time.
     *       
     *      The localtime() function returns an array identical to that of the structure returned
     *      by the C function call.
     * 
     * Syntax:
     ...
     *      
     *      associative:
     *          Determines whether the functions should returns a regular, numerically indexed
     ...
     *      localtime() returned an associative array containing the elements of the structure
     *      returned by the C function call to localtime. The keys of the associative array
     *      are a follows.
     * 
    ...
    <?php
    heading(1, "Get localtime information");

    heading(3, "Today localtime with indexed array: ");
    ...
    <!-- Today localtime with associative array. -->
    <?php
    // here we will get the localtime 
    heading(3, "localtime with associative array: ");
    $timestamp = localtime(time(), true);
    // Note here Return current Unix timestamp
